...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validatePassword(password)) {
      toast.error(
        "Password is too weak. It must be at least 8 characters and include uppercase, lowercase, and numbers.",
        {
          position: "top-right",
          autoClose: 5000,
        }
        ...
        >
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center py-2">
            ...
            >
              Create Your Account
              <br />
              <span style={{ color: "#F48120" }}>Start Automating</span>
            </h1>
            ...
            >
              Join thousands of businesses using AI-powered sales bots to close
              deals around the clock. No credit card required.
            </p>
